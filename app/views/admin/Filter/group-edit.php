...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="needs-validation" action="<?= ADMIN; ?>/filter/group-edit" method="post" novalidate>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="title">Наименование группы фильтров</label>
                                <input type="text" name="title" class="form-control" id="title"
                                       placeholder="Наименование группы фильтров" value="<?=h($group->title);?>" required>
