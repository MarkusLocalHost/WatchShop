...
<head>
    ...
    <!-- Chat -->
    <link href="chat/style/chat.css" rel="stylesheet" />
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?=ADMIN;?>/main" class="nav-link">Главная</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?=ADMIN;?>/contacts" class="nav-link">Контакты</a>
            </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="<?=ADMIN;?>/chat" class="dropdown-item dropdown-footer">Зайти в чат</a>
                </div>
            </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?=PATH;?>" class="brand-link">
            <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">LUXURY Watch</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="<?=ADMIN;?>/profile" class="d-block"><?=$_SESSION['user']['name'];?></a>
                </div>
            </div>
...
<!-- Chat -->
<script src="chat/script/chat.js"></script>
